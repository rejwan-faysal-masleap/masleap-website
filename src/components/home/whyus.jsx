    ...
    <>
      <div className="md:min-h-[50vh] text-xl flex-between md:flex-row flex-col max-w-[1600px] mx-auto py-20 pt-24 md:py-0 md:pt-0 text-center md:text-left p-6">
        <section className="md:flex-1/2 flex-center flex-col space-y-10">
          <p className="head-title text-3xl font-[550px]" data-aos="fade-up" data-aos-duration="500">
            Why choose Masleap for project management and defining the scope of
            work?
          </p>
          <p data-aos="fade-up" data-aos-duration="1000" className="small-paragaraph">
        ...
        <section className="flex-1/2 hidden md:block">
          <div className="w-full h-screen flex items-center justify-end pr-40">
            <div className=" h-[450px] w-[350px] relative overflow-visible" data-aos="fade-left" data-aos-duration="1200">
