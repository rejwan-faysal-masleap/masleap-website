...
export const NavItems = ({
  ...
  return (
    <motion.div
      ...
      className={cn(
        "absolute inset-0 hidden flex-1 flex-row items-center justify-center space-x-2  font-medium text-zinc-600 transition duration-200 hover:text-zinc-800 lg:flex lg:space-x-2 text-xl",
        className
      )}>
      {items.map((item, idx) => (
        <a
...
export const NavbarLogo = () => {
  return (
    <a
      href="/"
      className="relative z-20 mr-4 flex items-center space-x-3 px-2 py-1 text-black">
      <img
        src="/images/logo.png"
        alt="logo"
        width={50}
